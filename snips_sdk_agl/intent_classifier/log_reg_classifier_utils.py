...
from snips_sdk_agl.constants import (DATA, ENTITY, INTENTS, TEXT,
                                 UNKNOWNWORD, UTTERANCES)
from snips_sdk_agl.data_augmentation import augment_utterances
from snips_sdk_agl.dataset import get_text_from_chunks
...
from snips_sdk_agl.resources import get_noise
