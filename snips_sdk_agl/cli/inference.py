...
def parse(training_path, query, verbose=False, intents_filter=None):
    ...
    from snips_sdk_agl import SnipsNLUEngine
    from snips_sdk_agl.cli.utils import set_nlu_logger
...
def print_parsing_result(engine, query, intents_filter):
    from snips_sdk_agl.common.utils import unicode_string, json_string
