...
def link(origin, link_name, force=False, resources_path=None):
    ...
    """
    from snips_sdk_agl.cli.utils import PrettyPrintLevel, pretty_print
...
def link_resources(origin, link_name, force, resources_path):
    ...
    from snips_sdk_agl.cli.compatibility import create_symlink
    from snips_sdk_agl.common.utils import get_package_path, is_package
    from snips_sdk_agl.constants import DATA_PATH
    from snips_sdk_agl.resources import get_resources_sub_directory
