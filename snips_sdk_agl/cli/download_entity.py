...
def download_builtin_entity(entity_name, language, *pip_args):
    ...
    from snips_sdk_agl import __about__
    from snips_sdk_agl.cli.download import download_from_resource_name
    from snips_sdk_agl.cli.utils import (
...
def _download_and_link_entity(long_resource_name, entity_name, language,
    ...
    from snips_sdk_agl.cli.link import link_resources
    from snips_sdk_agl.cli.utils import (
        PrettyPrintLevel, get_json, get_resources_version,
        install_remote_package, pretty_print)
    from snips_sdk_agl.common.utils import get_package_path
