...
from snips_sdk_agl.common.from_dict import FromDict
from snips_sdk_agl.constants import CUSTOM_ENTITY_PARSER_USAGE, STOP_WORDS
from snips_sdk_agl.entity_parser import CustomEntityParserUsage
from snips_sdk_agl.pipeline.configs import ProcessingUnitConfig
from snips_sdk_agl.resources import merge_required_resources
...
class ProbabilisticIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    def __init__(self, intent_classifier_config=None, slot_filler_config=None):
        from snips_sdk_agl.intent_classifier import IntentClassifier
        from snips_sdk_agl.slot_filler import SlotFiller

        if intent_classifier_config is None:
            from snips_sdk_agl.pipeline.configs import LogRegIntentClassifierConfig
    ...
    @property
    def unit_name(self):
        from snips_sdk_agl.intent_parser import ProbabilisticIntentParser
...
class DeterministicIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from snips_sdk_agl.intent_parser import DeterministicIntentParser
...
class LookupIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from snips_sdk_agl.intent_parser.lookup_intent_parser import \
            LookupIntentParser
