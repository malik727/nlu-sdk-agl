...
from nlu_sdk_agl.constants import DATA, ENTITY, SLOT_NAME, TEXT, UTTERANCES
from nlu_sdk_agl.exceptions import IntentFormatError
...
class Intent(object):
    ...
    def from_yaml(cls, yaml_dict):
        ...
        if isinstance(yaml_dict, IOBase):
            from nlu_sdk_agl.dataset.yaml_wrapper import yaml
