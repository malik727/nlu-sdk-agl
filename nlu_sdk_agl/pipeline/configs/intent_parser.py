...
from nlu_sdk_agl.constants import CUSTOM_ENTITY_PARSER_USAGE, STOP_WORDS
...
class ProbabilisticIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_sdk_agl.intent_parser import ProbabilisticIntentParser
...
class DeterministicIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_sdk_agl.intent_parser import DeterministicIntentParser
...
class LookupIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_sdk_agl.intent_parser.lookup_intent_parser import \
            LookupIntentParser
