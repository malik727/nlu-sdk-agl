...
from nlu_sdk_agl.constants import STOP_WORDS
...
class CRFSlotFillerConfig(FromDict, ProcessingUnitConfig):
    ...
    def __init__(self, feature_factory_configs=None,
        ...
        if tagging_scheme is None:
            from nlu_sdk_agl.slot_filler.crf_utils import TaggingScheme
    ...
    @property
    def unit_name(self):
        from nlu_sdk_agl.slot_filler import CRFSlotFiller
