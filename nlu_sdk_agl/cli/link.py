...
def link(origin, link_name, force=False, resources_path=None):
    ...
    """
    from nlu_sdk_agl.cli.utils import PrettyPrintLevel, pretty_print
...
def link_resources(origin, link_name, force, resources_path):
    ...
    from nlu_sdk_agl.cli.compatibility import create_symlink
    from nlu_sdk_agl.common.utils import get_package_path, is_package
    from nlu_sdk_agl.constants import DATA_PATH
    from nlu_sdk_agl.resources import get_resources_sub_directory
