...
def get_arg_parser():
    from nlu_sdk_agl.cli.download import (
        add_download_parser, add_download_all_languages_parser)
    from nlu_sdk_agl.cli.download_entity import (
        add_download_entity_parser, add_download_language_entities_parser)
    from nlu_sdk_agl.cli.generate_dataset import add_generate_dataset_subparser
    from nlu_sdk_agl.cli.inference import add_parse_parser
    from nlu_sdk_agl.cli.link import add_link_parser
    from nlu_sdk_agl.cli.metrics import (
        add_cross_val_metrics_parser, add_train_test_metrics_parser)
    from nlu_sdk_agl.cli.training import add_train_parser
    from nlu_sdk_agl.cli.versions import (
...
def main():
    from nlu_sdk_agl.__about__ import __version__
